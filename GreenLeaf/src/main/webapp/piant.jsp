...
<div class="container-plant">
    ...
    <div class="card">
        ...
        <div class="card__content">
            ...
            <p>Posizionare quindi la pianta sul letto di terriccio creato e controllare che il colletto della pianta sia
                a livello del terreno.
                E' importante considerare che se il colletto e' superiore al livello del terreno la pianta rischia di
                morire per esposizione
                delle radici. Nel caso in cui il colletto e' inferiore al livello del terreno, la pianta presenta
                maggiori rischi di contrarre
