    ...
    <div class="card-wrapper">
        <div class="card">
            ...
            <div class="product-content">
                <h2 class="product-title"><%= article.getIdAlbero()%>
                </h2><!-- id albero -->
                <hr>
                ...
                <div class="product-detail">
                    <h2>Descrizione: </h2>
                    <p><%= cbean.getDescrizione()%>
                    </p>
                    <p><span>Categoria</span>: <%= cbean.getNomeCategoria()%>
                    </p>
                    <p><span>Co2</span>: <%= article.getCo2()%>
                    </p>
                    <p><span>Stato</span>: <%= article.getStato()%>
                    </p>
                </div>
