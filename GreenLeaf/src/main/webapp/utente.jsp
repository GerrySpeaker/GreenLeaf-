...
<div class="all-userpage" id="user">
    ...
    <div class="page">
        ...
        <div class="tasks-wrapper">
            <div class="space">
                <p><span> Email:</span> <%= uBean.getEmail() %>
                </p>
                <p class="cap"><span> Nome:</span> <%= uBean.getNomeUtente() %>
                </p>
                <p class="cap"><span>Cognome:</span> <%= uBean.getCognomeUtente() %>
                </p>
                <p><span>Data di nascita:</span> <%= uBean.getDataNascita() %>
                </p>
            </div>
        </div>
    </div>
