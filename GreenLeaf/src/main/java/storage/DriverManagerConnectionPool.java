...
public class DriverManagerConnectionPool {
   ...
   *
   * @return una nuova connessione se tutto � andato a buon fine, null altrimenti
   */
  public static synchronized Connection createDbConnection() {
    try {
      ...
      String port = "3306";
      String db =
          "greenleaf?serverTimezone=UTC&useLegacyDatetimeCode=false&useUnicode=true"
   ...
   * @throws SQLException se c'� un errore di sintassi SQL
   */
   ...
   * @throws SQLException se c'� qualche errore a livello di sintassi SQL
   */
