...
public class Delete extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      String mailUtente = (String) request.getSession()
          .getAttribute("email"); //l'email dell'utente che si prende dalla sessione
      System.out.println(mailUtente);
      String mailOperatore = request.getParameter("emailOP");
      //l'email che prendiamo da ajax quando l'admin vuole eliminare un account operatore
