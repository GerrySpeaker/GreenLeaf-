...
<div class="all-carrello">
    <div class="wrapper">
        ...
        <div class="project">
            ...
            <div class="shop">
                <div class="box">
                    ...
                    <div class="content">
                        <h3>Nome</h3>
                        <h5>50.00</h5>
                        <p class="unit"><input class="quantity" id="quantity" type = "number" min = "1" value = "1"></p> <!--Il value va inserito quante ne ha chiesto-->
                        <p class="btn-area">
                            <a href="" class="btn-2">Rimuovi</a>
                        </p>
                        <p class="btn-area2">
                            <a class="btn-2" onclick="aggiorna()">Aggiorna</a>
                        </p>
                    </div>
                </div>
            </div>
            <!-- a qua -->
            <div class="right-bar">
                <p>Prezzo <span id="prezzo">50.00</span></p>
