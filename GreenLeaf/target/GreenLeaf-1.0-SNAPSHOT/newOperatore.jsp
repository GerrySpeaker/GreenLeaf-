        ...
        <form action="CreaOperatoreApplication" class="form" method="post" onsubmit="return validate(this)">
            ...
            <div class="column">
                ...
                <div class="input-box">
                    ...
                    <input id="password" type="password" placeholder="Inserisci qui la tua password" required
                           name="password"/>
            ...
            <p id="txt-regione"></p>
            <div class="dropdown">
                <input type="text" class="filterBox" placeholder="Regioni" readonly name="regione" value="Regione"
                       id="reg">
                <div class="option">
