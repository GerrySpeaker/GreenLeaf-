    ...
    <div class="card-wrapper">
        <div class="card">
            ...
            <div class="product-content">
                <h2 class="product-title"><%= albero.getIdAlbero()%>
                </h2><!-- id albero -->
                <hr>

                <div class="product-detail">
                    <p><span>Categoria</span>: <%= albero.getCategoria()%>
                    </p>
                    <p><span>Co2</span>: <%= albero.getCo2()%>
                    </p>
                    <p><span>Stato</span>: <%= albero.getStato()%>
                    </p>
                </div>
                ...
                <div class="iot">
                    <h3>IOT</h3>
                    <ul>
                        <li><span>Ipv4</span>: <%=iot.getIpv4()%>
                        </li>
                        <li><span>Latitudine</span>: <%=iot.getLatitudine()%>
                        </li>
                        <li><span>Longitudine</span>: <%=iot.getLongitudine()%>
                        </li>
                    </ul>
                </div>
